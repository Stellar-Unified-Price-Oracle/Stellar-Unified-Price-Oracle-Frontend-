...
import type { SourceName as _SourceName } from './price'
...
export interface Alert {
  ...
  /** Divergence alert (#458): fire when max pairwise deviation between sources exceeds this % (0–100). null = disabled */
...
export interface AlertFormData {
  ...
  /** String representation of divergenceThreshold (#458); empty string = not set */
...
// ---------------------------------------------------------------------------
// #458 — Source Divergence (inter-oracle spread detection)
// ---------------------------------------------------------------------------
 ...
 */
export type SourcePriceMap = Partial<Record<_SourceName, number>>

/**
 * Result of computeSourceSpread for a given asset pair.
 */
export interface DivergenceResult {
  ...
  highSource: _SourceName | null
  lowSource: _SourceName | null
